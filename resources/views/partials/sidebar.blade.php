...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li v-if="$can('development_access')">
                <router-link :to="{ name: 'developments.index' }">
                    <i class="fa fa-gears"></i>
                    <span>@lang('quickadmin.development.title')</span>
                </router-link>
            </li>
            <li v-if="$can('production_access')">
                <router-link :to="{ name: 'productions.index' }">
                    <i class="fa fa-gears"></i>
                    <span>@lang('quickadmin.production.title')</span>
                </router-link>
            </li>
            <li v-if="$can('receipt_access')">
                <router-link :to="{ name: 'receipts.index' }">
                    <i class="fa fa-money"></i>
                    <span>@lang('quickadmin.receipts.title')</span>
                </router-link>
            </li>
