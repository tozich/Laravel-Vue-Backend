...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Technologies', field: 'technologies', sortable: true },
                { title: 'Project duration', field: 'project_duration', sortable: true },
                { title: 'Working hours', field: 'working_hours', sortable: true },
    ...
    methods: {
        ...mapActions('ReceiptsIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
